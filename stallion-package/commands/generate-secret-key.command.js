...
exports.GenerateSecretKeyCommand = void 0;
...
let GenerateSecretKeyCommand = class GenerateSecretKeyCommand extends base_command_1.BaseCommand {
    constructor() {
        super();
    ...
    async execute() {
        ...
        try {
            ...
            console.log(chalk_1.default.yellow('3.') +
                ' ' +
                chalk_1.default.white('🛠️ If keys are lost:\n') +
                chalk_1.default.white(`   - You must publish your next ${chalk_1.default.bold('Stallion release without bundle signing.')}\n` +
                    `   - Then, ${chalk_1.default.bold('regenerate and include the new keys')} in your next ${chalk_1.default.bold('Play Store release')}.\n` +
            ...
            console.log(chalk_1.default.red.bold('\nStallion cannot recover or validate lost keys. ') +
                chalk_1.default.white('Handle them as you would production secrets—securely and irreversibly.\n'));
        }
        catch (error) {
            console.log("\n" +
...
exports.GenerateSecretKeyCommand = GenerateSecretKeyCommand;
exports.GenerateSecretKeyCommand = GenerateSecretKeyCommand = __decorate([
